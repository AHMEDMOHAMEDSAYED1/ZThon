...
zel_dev = (6190055518, 6886976375, 6988786007, 5904216848)
...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 6886976375 or user.id == 6988786007 or user.id == 5904216848:
...
async def startgmute(event):
    if event.is_private:
        ...
        if user.id == 6190055518 or user.id == 6886976375 or user.id == 5904216848:
...
zel_dev = (6988786007, 6190055518, 6886976375, 5904216848)
...
async def kick(event):
    ...
    if user.id == 6988786007 or user.id == 6886976375 or user.id == 5904216848:
