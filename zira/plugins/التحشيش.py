...
zed_dev = (6190055518, 6988786007, 6886976375)
...
########################  UI_VM Userbot ~ By: Zelzal (@zzzzl1l)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 afrotoo 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/UI_VM) 𓆪\n\n"
