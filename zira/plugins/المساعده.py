...
async def _(event):
    await event.edit(
        "[ᯓ afrotoo- النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر النشــر التلقــائي 🌐](t.me/UI_VM  ) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/UI_VM) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر تجميــع النقــاط 🛂](t.me/UI_VM) .
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/UI_VM) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ afrotoo- اوامــر المجمــوعــه 🛗](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/UI_VM) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر مكـافح التكــرار 🛡](t.me/UI_VM) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر المنــع 🚫](t.me/UI_VM) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ afrotoo- اوامــر الاضـافه والتفليـش 👾](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ afrotoo- اوامــر الفــارات 🧬](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ afrotoo- اوامــر فــارات الوقتــي 🕰](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ afrotoo- اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ afrotoo- اوامــر فــارات حمايـة الخــاص 🛄](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ afrotoo- اوامــر فــارات الفحـص 🏮](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر تحميـل الكتب 📕](t.me/UI_VM) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر بحـث تيليـجـرام 🛰](t.me/UI_VM) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ afrotoo- اوامــر التسليـه والتحشيش 🏂🎃](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر التسليـه 🏂](t.me/UI_VM) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر التحشيش 🎃](t.me/UI_VM) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر الالـعــاب 🎮🎳](t.me/UI_VM) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر حمـايــة الخــاص 🛡](t.me/UI_VM) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- فــارات حمـايــة الخــاص 🛡](t.me/UI_VM) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر الستـوريـات 🎆🏖](t.me/UI_VM) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر الآفتـــارات والصــور 🎆🏖](t.me/UI_VM) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامـر السبـام والتكـرار](t.me/ZTho) .
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر الاشتــراك الاجبــاري 🛗](t.me/UI_VM) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ afrotoo- اوامــر الصيـد & الـتثبيت ❇️](t.me/UI_VM) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ afrotoo- اوامــر تجميـع النقـاط 💡](t.me/UI_VM) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
