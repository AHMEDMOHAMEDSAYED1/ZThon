...
ZDEV = (5904216848, 6988786007, 6886976375, 6547424888, 5867878534, 6190055518)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @UI_VM\
                                  \n\n--------بـدء تتبـع سجـل عفرتو AFROTOO--------\
                        ...
                        link = "[AFROTOO](https://t.me/VVYVVJ)"
                        text = (
                            "**✘ تقـريـر اشعـار عفرتو AFROTOO ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع عفرتو AFROTOO --------"
                        command = 'git log --pretty=format:"%an: %s" -5'
                        ftext += "\n\n\n- آخـر 5 ملفـات تم تحديثهـا :\n"
                        output = (await runcmd(command))[:2]
                        result = output[0] + output[1]
